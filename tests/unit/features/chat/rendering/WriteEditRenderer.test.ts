...
describe('WriteEditRenderer', () => {
  describe('createWriteEditBlock', () => {
    ...
    it('should start collapsed by default', () => {
      ...
      expect(state.contentEl.hasClass('octo-hidden')).toBe(true);
    ...
    it('should start expanded when requested', () => {
      ...
      expect(state.contentEl.hasClass('octo-hidden')).toBe(false);
  ...
  describe('renderStoredWriteEdit', () => {
    ...
    it('should start collapsed by default', () => {
      ...
      const block = renderStoredWriteEdit(parentEl, toolCall);
      const headerEl = block.querySelector('.octo-write-edit-header');
      const contentEl = block.querySelector('.octo-write-edit-content');

      expect(block.hasClass('expanded')).toBe(false);
      expect(contentEl?.hasClass('octo-hidden')).toBe(true);
