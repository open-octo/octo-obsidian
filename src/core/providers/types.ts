...
export const DEFAULT_CHAT_PROVIDER_ID = 'octo-agent' as const satisfies ProviderId;
...
export interface ProviderRegistration {
  ...
  createInlineEditService: (plugin: OctoPlugin) => InlineEditService;
